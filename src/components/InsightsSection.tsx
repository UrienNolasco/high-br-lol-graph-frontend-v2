...
import { CheckIcon, ChevronsUpDownIcon, Database } from "lucide-react";
import {
  ResponsiveContainer,
  LineChart,
  Line,
...
export const InsightsSection = () => {
  ...
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="mb-12">
        <h2 className="text-3xl font-bold text-white">Meta Snapshot</h2>
        <p className="text-textMuted mb-2">
          Key performance between the patches.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <GlassCard className="relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h3 className="text-textMuted text-sm font-medium">
                  Top Performer
                </h3>
            ...
            <div className="mt-4 flex gap-2">
              <button className="text-xs text-hextech hover:underline">
                View Build
              </button>
            </div>
          </div>
        ...
        <GlassCard className="relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xs text-textDark mt-4">
              Aatrox leads with 65% lane prio.
            </p>
          </div>
        </GlassCard>
        ...
        {/* Card 4: Ban Rate */}
        <GlassCard>
          <h3 className="text-textMuted text-sm font-medium mb-4">
            Ban Rate Trends
          </h3>
          ...
          <p className="text-xs text-center text-textDark mt-2">
            Zed remains top ban
          </p>
        </GlassCard>
      </div>
